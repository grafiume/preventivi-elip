...
/*! elip-complete-patch.v2.6.js
   - Header (#quoteId) mostra SOLO il numero preventivo (vuoto prima del salvataggio).
   - Fix robustezza: tutti i riferimenti a #okPill sono opzionali (no crash se manca).
   - Mantiene: Nuovo forzato, guardie recalc, filtri Archivio/contatori, hook save/fetch/poll.
*/
(function(){
  'use strict';
  ...
  // Patch fillForm: sincronizza header e okPill (se presente)
  ...
  // Wrap recalc: guardie + okPill live update (se presente)
