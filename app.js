...
Totale: ${EURO(tot)}`);
  ...
  function showDeadlineAlert(html){ /* no-op: editor alert rimosso */ }
  function hideDeadlineAlert(){ /* no-op: editor alert rimosso */ }
  function applyScadenzaInputStyle(isWarn){ /* no-op: rimosso colore rosso campo */ }
