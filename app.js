...
document.addEventListener('DOMContentLoaded', () => {
  ...
  catalog.innerHTML = `<div class="card p-3 mb-3"><h5>Catalogo voci</h5>
  <ul class="list-group">
    <li class="list-group-item d-flex justify-content-between align-items-center">
      Avvolgimento indotto <span>100 €</span>
    </li>
    <li class="list-group-item d-flex justify-content-between align-items-center">
      Tornitura rotore <span>80 €</span>
    </li>
  </ul></div>`;

  const archive = document.getElementById('archiveContainer');
  archive.innerHTML = `<div class="card p-3"><h5>Archivio preventivi</h5>
  <p class="text-muted">Qui verranno visualizzati i preventivi salvati.</p></div>`;
